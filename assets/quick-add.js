  ...
  customElements.define(
    ...
    class QuickAddModal extends ModalDialog {
      ...
      hide(preventFocus = false) {
        ...
        // Don't clear content immediately - wait for fade-out animation to complete
        // The modal has a 0.3s transition, so wait slightly longer to ensure animation completes
        setTimeout(() => {
          this.modalContent.innerHTML = '';
        }, 350); // 350ms to account for 300ms transition + small buffer
